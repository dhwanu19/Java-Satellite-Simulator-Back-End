...
/**
 * Represents a generic 'angle' that is either degrees or radians and allows
...
public final class Angle {
    ...
    /**
     * Compare this angle to another angle. Returns... 1 if this is greater than
     * other 0 if this is equal to other -1 if this is less than other
     */
    ...
    /**
     * Add another angle to this angle and return a new angle representing the
     * result.
     */
    ...
    /**
     * subtract another angle from this angle and return a new angle representing
     * the result.
     */
